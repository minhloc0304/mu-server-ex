...
{
	PBMSG_HEAD h;
	unsigned char iBridgeNumber;
	unsigned char iItemPos;
};
...
public:
	...
	// ----
	void ReadFile();
	char GetBloodCastleIndex(int MapNumber);
	int GetBloodCastleMap(int BridgeNumber);
	void LogBloodCastleWeaponDrop(int BridgeIndex,int level);
	void GiveReward(int aIndex,int BridgeIndex);
	// ---- Reward
	int MinReward[MAX_BLOOD_CASTLE_LEVEL];
	int MaxReward[MAX_BLOOD_CASTLE_LEVEL];
	int ItemCount[MAX_BLOOD_CASTLE_LEVEL];

	unsigned char Type[MAX_BLOOD_CASTLE_LEVEL][255];
	unsigned short Index[MAX_BLOOD_CASTLE_LEVEL][255];
	unsigned char Level[MAX_BLOOD_CASTLE_LEVEL][255];
	unsigned char Dur[MAX_BLOOD_CASTLE_LEVEL][255];
	unsigned char Skill[MAX_BLOOD_CASTLE_LEVEL][255];
	unsigned char Luck[MAX_BLOOD_CASTLE_LEVEL][255];
	unsigned char Opt[MAX_BLOOD_CASTLE_LEVEL][255];
	unsigned char Exe[MAX_BLOOD_CASTLE_LEVEL][255];
	unsigned char Anc[MAX_BLOOD_CASTLE_LEVEL][255];
	unsigned char Socket[5][MAX_BLOOD_CASTLE_LEVEL][255];
	// ----
	void RequestEnterBloodCastle(PMSG_REQ_MOVEBLOODCASTLE* lpMsg, int iIndex);
	// ----
...
public:
	...
	int TimeMinRest;
	// ----
	int DoorHealth[MAX_BLOOD_CASTLE_LEVEL];
	int BloodCastleMixSuccess[MAX_BLOOD_CASTLE_LEVEL];
	int BloodCastleMixMoney[MAX_BLOOD_CASTLE_LEVEL];
	int BloodCastleZenReward[MAX_BLOOD_CASTLE_LEVEL];
	...
	// ----
	int AuxTimer[MAX_BLOOD_CASTLE_LEVEL];
};
