...
typedef struct SETITEM_OPTIONINFO	// 50
{
	...
	BYTE RequireClass[MAX_CLASS_TYPE+1];	// 1A0
...
public:
	...
	int GetSetOption(int optionindex, int optablenum, int& op1, int& op2, int& opvalue1,int& opvalue2, int Class, int ChangeUp, int ChangeUp2);
	int GetMaxSetOptionCount(int optionindex);
	int GetGetFullSetOption(int optionindex, int& op1, int& op2, int& op3, int& op4, int& op5, int& opvalue1, int& opvalue2, int& opvalue3, int& opvalue4, int& opvalue5, int Class, int ChangeUp, int ChangeUp2);
	BOOL IsRequireClass(int optionindex, int Class, int ChangeUP, int ChangeUP2);
